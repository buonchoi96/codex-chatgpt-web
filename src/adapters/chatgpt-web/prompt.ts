...
export function compileChatGptWebPrompt(
  ...
  const transportContract = parsed._compactionRequest
    ...
    ? [
      ...
      "The codex_windows_computer_use_* bridge tools are deprecated ABI stubs only. Never use them for desktop work; they intentionally fail fast. Use official node_repl + @oai/sky for native Windows Computer Use.",
